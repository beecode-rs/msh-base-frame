...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodRecordInternals
...
- [`$ZodTypeInternals`]($ZodTypeInternals-1.md)\<[`$InferZodRecordOutput`](../type-aliases/$InferZodRecordOutput.md)\<`Key`, `Value`\>, [`$InferZodRecordInput`](../type-aliases/$InferZodRecordInput.md)\<`Key`, `Value`\>\>
...
> **input**: [`$InferZodRecordInput`](../type-aliases/$InferZodRecordInput.md)
...
> **isst**: [`$ZodIssueInvalidType`]($ZodIssueInvalidType.md)\<`unknown`\> \| [`$ZodIssueInvalidKey`]($ZodIssueInvalidKey.md)\<`Record`\<`PropertyKey`, `unknown`\>\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:750
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:751
...
> **output**: [`$InferZodRecordOutput`](../type-aliases/$InferZodRecordOutput.md)
