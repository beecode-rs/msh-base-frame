...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodBoolean

# Interface: $ZodBoolean\<T\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:428
...
> **\_zod**: [`$ZodBooleanInternals`]($ZodBooleanInternals.md)\<`T`\>
...
> **~standard**: [`$ZodStandardSchema`](../type-aliases/$ZodStandardSchema.md)\<`$ZodBoolean`\<`T`\>\>
