...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodMapInternals
...
- [`$ZodTypeInternals`]($ZodTypeInternals-1.md)\<`Map`\<[`output`](../type-aliases/output.md)\<`Key`\>, [`output`](../type-aliases/output.md)\<`Value`\>\>, `Map`\<[`input`](../type-aliases/input.md)\<`Key`\>, [`input`](../type-aliases/input.md)\<`Value`\>\>\>
...
> **isst**: [`$ZodIssueInvalidType`]($ZodIssueInvalidType.md)\<`unknown`\> \| [`$ZodIssueInvalidKey`]($ZodIssueInvalidKey.md)\<`unknown`\> \| [`$ZodIssueInvalidElement`]($ZodIssueInvalidElement.md)\<`unknown`\>
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:769
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:770
