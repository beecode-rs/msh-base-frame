...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodTypeDef
...
> **type**: `"string"` \| `"number"` \| `"bigint"` \| `"boolean"` \| `"symbol"` \| `"undefined"` \| `"object"` \| `"function"` \| `"optional"` \| `"int"` \| `"null"` \| `"void"` \| `"never"` \| `"any"` \| `"unknown"` \| `"date"` \| `"record"` \| `"file"` \| `"array"` \| `"tuple"` \| `"union"` \| `"intersection"` \| `"map"` \| `"set"` \| `"enum"` \| `"literal"` \| `"nullable"` \| `"nonoptional"` \| `"success"` \| `"transform"` \| `"default"` \| `"prefault"` \| `"catch"` \| `"nan"` \| `"pipe"` \| `"readonly"` \| `"template_literal"` \| `"promise"` \| `"lazy"` \| `"custom"`
