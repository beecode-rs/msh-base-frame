...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodSetInternals
...
- [`$ZodTypeInternals`]($ZodTypeInternals-1.md)\<`Set`\<[`output`](../type-aliases/output.md)\<`T`\>\>, `Set`\<[`input`](../type-aliases/input.md)\<`T`\>\>\>
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:784
