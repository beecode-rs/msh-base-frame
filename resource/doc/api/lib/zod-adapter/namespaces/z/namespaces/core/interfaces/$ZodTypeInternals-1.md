...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodTypeInternals

# Interface: $ZodTypeInternals\<O, I\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:87
...
- [`$ZodStringInternals`]($ZodStringInternals.md)
- [`$ZodNumberInternals`]($ZodNumberInternals.md)
- [`$ZodBooleanInternals`]($ZodBooleanInternals.md)
- [`$ZodBigIntInternals`]($ZodBigIntInternals.md)
- [`$ZodSymbolInternals`]($ZodSymbolInternals.md)
- [`$ZodUndefinedInternals`]($ZodUndefinedInternals.md)
- [`$ZodNullInternals`]($ZodNullInternals.md)
- [`$ZodAnyInternals`]($ZodAnyInternals.md)
- [`$ZodUnknownInternals`]($ZodUnknownInternals.md)
- [`$ZodNeverInternals`]($ZodNeverInternals.md)
- [`$ZodVoidInternals`]($ZodVoidInternals.md)
- [`$ZodDateInternals`]($ZodDateInternals.md)
- [`$ZodRecordInternals`]($ZodRecordInternals.md)
- [`$ZodMapInternals`]($ZodMapInternals.md)
- [`$ZodSetInternals`]($ZodSetInternals.md)
- [`$ZodEnumInternals`]($ZodEnumInternals.md)
- [`$ZodLiteralInternals`]($ZodLiteralInternals.md)
- [`$ZodFileInternals`]($ZodFileInternals.md)
- [`$ZodTransformInternals`]($ZodTransformInternals.md)
- [`$ZodOptionalInternals`]($ZodOptionalInternals.md)
- [`$ZodNullableInternals`]($ZodNullableInternals.md)
- [`$ZodDefaultInternals`]($ZodDefaultInternals.md)
- [`$ZodPrefaultInternals`]($ZodPrefaultInternals.md)
- [`$ZodNonOptionalInternals`]($ZodNonOptionalInternals.md)
- [`$ZodSuccessInternals`]($ZodSuccessInternals.md)
- [`$ZodCatchInternals`]($ZodCatchInternals.md)
- [`$ZodNaNInternals`]($ZodNaNInternals.md)
- [`$ZodPipeInternals`]($ZodPipeInternals.md)
- [`$ZodCodecInternals`]($ZodCodecInternals.md)
- [`$ZodReadonlyInternals`]($ZodReadonlyInternals.md)
- [`$ZodTemplateLiteralInternals`]($ZodTemplateLiteralInternals.md)
- [`$ZodFunctionInternals`]($ZodFunctionInternals.md)
- [`$ZodPromiseInternals`]($ZodPromiseInternals.md)
- [`$ZodLazyInternals`]($ZodLazyInternals.md)
- [`$ZodCustomInternals`]($ZodCustomInternals.md)
- [`$ZodTypeDiscriminableInternals`]($ZodTypeDiscriminableInternals.md)
...
> `optional` **parent?**: [`$ZodType`]($ZodType-1.md)\<`unknown`, `unknown`, `$ZodTypeInternals`\<`unknown`, `unknown`\>\>
