...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodOptionalInternals
...
- [`$ZodTypeInternals`]($ZodTypeInternals-1.md)\<[`output`](../type-aliases/output.md)\<`T`\> \| `undefined`, [`input`](../type-aliases/input.md)\<`T`\> \| `undefined`\>
...
> **output**: [`output`](../type-aliases/output.md)\<`T`\> \| `undefined`
