...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodDefault
...
> **\_zod**: [`$ZodDefaultInternals`]($ZodDefaultInternals.md)\<`T`\>
...
> **~standard**: [`$ZodStandardSchema`](../type-aliases/$ZodStandardSchema.md)\<`$ZodDefault`\<`T`\>\>
