...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodNullableInternals
...
- [`$ZodTypeInternals`]($ZodTypeInternals-1.md)\<[`output`](../type-aliases/output.md)\<`T`\> \| `null`, [`input`](../type-aliases/input.md)\<`T`\> \| `null`\>
...
> **input**: [`input`](../type-aliases/input.md)\<`T`\> \| `null`
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:893
...
> **output**: [`output`](../type-aliases/output.md)\<`T`\> \| `null`
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:897
