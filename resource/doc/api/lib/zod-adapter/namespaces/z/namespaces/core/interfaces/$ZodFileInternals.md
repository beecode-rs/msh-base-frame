...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodFileInternals
...
- [`$ZodTypeInternals`]($ZodTypeInternals-1.md)\<[`File`](File.md), [`File`](File.md)\>

## Properties

### bag

> **bag**: [`LoosePartial`](../../util/type-aliases/LoosePartial.md)\<\{ `maximum`: `number`; `mime`: [`MimeTypes`](../../util/type-aliases/MimeTypes.md)[]; `minimum`: `number`; \}\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:838
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:837
