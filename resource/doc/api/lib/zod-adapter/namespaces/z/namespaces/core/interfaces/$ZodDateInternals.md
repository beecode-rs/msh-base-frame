...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodDateInternals
...
- [`$ZodTypeInternals`]($ZodTypeInternals-1.md)\<`Date`, `T`\>
...
> **bag**: [`LoosePartial`](../../util/type-aliases/LoosePartial.md)\<\{ `format`: `string`; `maximum`: `Date`; `minimum`: `Date`; \}\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:549
