...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodPromiseInternals
...
- [`$ZodTypeInternals`]($ZodTypeInternals-1.md)\<`Promise`\<[`output`](../type-aliases/output.md)\<`T`\>\>, [`MaybeAsync`](../../util/type-aliases/MaybeAsync.md)\<[`input`](../type-aliases/input.md)\<`T`\>\>\>
...
> **input**: [`MaybeAsync`](../../util/type-aliases/MaybeAsync.md)
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:1139
