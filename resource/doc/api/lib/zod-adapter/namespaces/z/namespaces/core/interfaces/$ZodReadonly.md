...
[@beecode/msh-base-frame](../../../../../../../README.md) / [lib/zod-adapter](../../../../../README.md) / [z](../../../README.md) / [core](../README.md) / $ZodReadonly
...
> **\_zod**: [`$ZodReadonlyInternals`]($ZodReadonlyInternals.md)\<`T`\>
...
> **~standard**: [`$ZodStandardSchema`](../type-aliases/$ZodStandardSchema.md)\<`$ZodReadonly`\<`T`\>\>
