...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodUnion
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`$InferUnionOutput`](../namespaces/core/type-aliases/$InferUnionOutput.md)\<`T`\[`number`\]\>, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, [`$InferUnionOutput`](../namespaces/core/type-aliases/$InferUnionOutput.md)\<`T`\[`number`\]\>\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`$InferUnionOutput`](../namespaces/core/type-aliases/$InferUnionOutput.md)\<`T`\[`number`\]\>, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, [`$InferUnionOutput`](../namespaces/core/type-aliases/$InferUnionOutput.md)\<`T`\[`number`\]\>\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodUnion`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`$InferUnionInput`](../namespaces/core/type-aliases/$InferUnionInput.md)\<`T`\[`number`\]\>, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, [`$InferUnionInput`](../namespaces/core/type-aliases/$InferUnionInput.md)\<`T`\[`number`\]\>\>\> : `ZodUnion`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodUnion`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`$InferUnionInput`](../namespaces/core/type-aliases/$InferUnionInput.md)\<`T`\[`number`\]\>, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, [`$InferUnionInput`](../namespaces/core/type-aliases/$InferUnionInput.md)\<`T`\[`number`\]\>\>\> : `ZodUnion`\<`T`\>
