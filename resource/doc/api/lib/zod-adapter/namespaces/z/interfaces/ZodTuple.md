...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodTuple
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\], [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\], [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodTuple`\<`T`, `Rest`\> & [`ZodType`](ZodType-1.md)\<`R`, \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\], [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>\> : `ZodTuple`\<`T`, `Rest`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodTuple`\<`T`, `Rest`\> & [`ZodType`](ZodType-1.md)\<`R`, \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\], [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>\> : `ZodTuple`\<`T`, `Rest`\>
...
`R` *extends* [`$ZodRegistry`](../namespaces/core/classes/$ZodRegistry.md)\<`MetadataType`, [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`unknown`, `unknown`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`unknown`, `unknown`\>\>\>
...
`Rest` *extends* [`SomeType`](../namespaces/core/type-aliases/SomeType.md) = [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`unknown`, `unknown`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`unknown`, `unknown`\>\>
