...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodBoolean
...
[`ZodCoercedBoolean`](ZodCoercedBoolean.md).[`description`](ZodCoercedBoolean.md#description)
...
`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `boolean`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, `boolean`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodBoolean` & [`ZodType`](ZodType-1.md)\<`R`, `boolean`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `boolean`\>\> : `ZodBoolean`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodBoolean` & [`ZodType`](ZodType-1.md)\<`R`, `boolean`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `boolean`\>\> : `ZodBoolean`
