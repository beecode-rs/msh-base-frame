...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodDate
...
`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `Date`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, `Date`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodDate` & [`ZodType`](ZodType-1.md)\<`R`, `Date`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `Date`\>\> : `ZodDate`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodDate` & [`ZodType`](ZodType-1.md)\<`R`, `Date`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `Date`\>\> : `ZodDate`
