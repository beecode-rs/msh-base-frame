...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodInt32
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodInt32` & [`ZodType`](ZodType-1.md)\<`R`, `number`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `number`\>\> : `ZodInt32`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodInt32` & [`ZodType`](ZodType-1.md)\<`R`, `number`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `number`\>\> : `ZodInt32`
