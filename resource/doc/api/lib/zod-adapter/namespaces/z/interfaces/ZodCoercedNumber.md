...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodCoercedNumber
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedNumber`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `T`\>\> : `ZodCoercedNumber`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedNumber`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `T`\>\> : `ZodCoercedNumber`\<`T`\>
