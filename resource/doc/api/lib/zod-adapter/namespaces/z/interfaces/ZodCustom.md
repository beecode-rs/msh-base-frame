...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodCustom
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCustom`\<`O`, `I`\> & [`ZodType`](ZodType-1.md)\<`R`, `I`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `I`\>\> : `ZodCustom`\<`O`, `I`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCustom`\<`O`, `I`\> & [`ZodType`](ZodType-1.md)\<`R`, `I`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `I`\>\> : `ZodCustom`\<`O`, `I`\>
