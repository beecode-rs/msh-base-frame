...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodCoercedBigInt
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedBigInt`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `T`\>\> : `ZodCoercedBigInt`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedBigInt`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `T`\>\> : `ZodCoercedBigInt`\<`T`\>
