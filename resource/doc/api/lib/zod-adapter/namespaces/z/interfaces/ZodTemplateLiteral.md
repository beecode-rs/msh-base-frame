...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodTemplateLiteral
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `Template`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, `Template`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `Template`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, `Template`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodTemplateLiteral`\<`Template`\> & [`ZodType`](ZodType-1.md)\<`R`, `Template`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `Template`\>\> : `ZodTemplateLiteral`\<`Template`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodTemplateLiteral`\<`Template`\> & [`ZodType`](ZodType-1.md)\<`R`, `Template`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `Template`\>\> : `ZodTemplateLiteral`\<`Template`\>
