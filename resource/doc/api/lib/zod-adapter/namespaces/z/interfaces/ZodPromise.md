...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodPromise
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodPromise`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`MaybeAsync`](../namespaces/util/type-aliases/MaybeAsync.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\>\>, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, [`MaybeAsync`](../namespaces/util/type-aliases/MaybeAsync.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\>\>\>\> : `ZodPromise`\<`T`\>
