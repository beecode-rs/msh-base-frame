...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodJSONSchema
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`JSONType`](../type-aliases/JSONType.md), [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, [`JSONType`](../type-aliases/JSONType.md)\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`JSONType`](../type-aliases/JSONType.md), [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, [`JSONType`](../type-aliases/JSONType.md)\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodJSONSchema` & [`ZodType`](ZodType-1.md)\<`R`, [`JSONType`](../type-aliases/JSONType.md), [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, [`JSONType`](../type-aliases/JSONType.md)\>\> : `ZodJSONSchema`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodJSONSchema` & [`ZodType`](ZodType-1.md)\<`R`, [`JSONType`](../type-aliases/JSONType.md), [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, [`JSONType`](../type-aliases/JSONType.md)\>\> : `ZodJSONSchema`
