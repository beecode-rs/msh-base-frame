...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodEnum
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `T`\[keyof `T`\], [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, `T`\[keyof `T`\]\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `T`\[keyof `T`\], [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`any`, `T`\[keyof `T`\]\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodEnum`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`\[keyof `T`\], [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `T`\[keyof `T`\]\>\> : `ZodEnum`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodEnum`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`\[keyof `T`\], [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `T`\[keyof `T`\]\>\> : `ZodEnum`\<`T`\>
