...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodPreprocess
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodPreprocess`\<`B`\> & [`ZodType`](ZodType-1.md)\<`R`, `unknown`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `unknown`\>\> : `ZodPreprocess`\<`B`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodPreprocess`\<`B`\> & [`ZodType`](ZodType-1.md)\<`R`, `unknown`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `unknown`\>\> : `ZodPreprocess`\<`B`\>
