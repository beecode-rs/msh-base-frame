...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodUInt32
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodUInt32` & [`ZodType`](ZodType-1.md)\<`R`, `number`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `number`\>\> : `ZodUInt32`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodUInt32` & [`ZodType`](ZodType-1.md)\<`R`, `number`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `number`\>\> : `ZodUInt32`
