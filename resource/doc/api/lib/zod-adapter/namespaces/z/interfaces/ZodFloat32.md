...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodFloat32
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodFloat32` & [`ZodType`](ZodType-1.md)\<`R`, `number`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `number`\>\> : `ZodFloat32`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodFloat32` & [`ZodType`](ZodType-1.md)\<`R`, `number`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `number`\>\> : `ZodFloat32`
