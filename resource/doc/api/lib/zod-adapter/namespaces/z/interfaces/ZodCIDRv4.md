...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodCIDRv4
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCIDRv4` & [`ZodType`](ZodType-1.md)\<`R`, `string`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `string`\>\> : `ZodCIDRv4`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCIDRv4` & [`ZodType`](ZodType-1.md)\<`R`, `string`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `string`\>\> : `ZodCIDRv4`
