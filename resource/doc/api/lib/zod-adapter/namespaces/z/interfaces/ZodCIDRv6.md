...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodCIDRv6
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCIDRv6` & [`ZodType`](ZodType-1.md)\<`R`, `string`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `string`\>\> : `ZodCIDRv6`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCIDRv6` & [`ZodType`](ZodType-1.md)\<`R`, `string`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `string`\>\> : `ZodCIDRv6`
