...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / ZodCoercedString
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedString`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `T`\>\> : `ZodCoercedString`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedString`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, [`$ZodTypeInternals`](../namespaces/core/interfaces/$ZodTypeInternals-1.md)\<`R`, `T`\>\> : `ZodCoercedString`\<`T`\>
