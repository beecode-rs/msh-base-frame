...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / string

# Function: string()

## Call Signature

> **string**(`params?`): [`ZodString`](../interfaces/ZodString-1.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:170
...
> **string**\<`T`\>(`params?`): [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`T`, `T`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:171
...
[`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`T`, `T`\>
