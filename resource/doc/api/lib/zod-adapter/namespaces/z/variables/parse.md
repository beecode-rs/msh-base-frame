...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / parse

# Variable: parse

> `const` **parse**: \<`T`\>(`schema`, `value`, `_ctx?`, `_params?`) => [`output`](../namespaces/core/type-aliases/output.md)\<`T`\>

Defined in: node\_modules/zod/v4/classic/parse.d.cts:14
