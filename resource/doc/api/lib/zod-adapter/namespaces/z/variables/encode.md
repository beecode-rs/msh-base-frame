...
[@beecode/msh-base-frame](../../../../../README.md) / [lib/zod-adapter](../../../README.md) / [z](../README.md) / encode

# Variable: encode

> `const` **encode**: \<`T`\>(`schema`, `value`, `_ctx?`) => [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>

Defined in: node\_modules/zod/v4/classic/parse.d.cts:24
