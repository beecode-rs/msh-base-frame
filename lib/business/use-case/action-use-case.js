...
var actionUseCase = exports.actionUseCase = {
  clone: function () {
    var _clone = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var _config, _config$template, subFolderLocation, localDestinationFolder, fetchStrategy, fileAdapter, contentList, files, templateService, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 9:
            ...
            (0, _logger.logger)().error('Some file already exist, you need to compare folder manually', _t.message);
            return _context.a(2);
          case 10:
