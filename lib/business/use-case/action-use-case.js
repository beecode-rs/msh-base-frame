...
var actionUseCase = exports.actionUseCase = {
  clone: function () {
    var _clone = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _config, _config$template, subFolderLocation, localDestinationFolder, fetchStrategy, fileAdapter, contentList, files, templateService;
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            return Promise.all(files.map(function (filePath) {
              return templateService.renderAndOverrideFile({
                filePath: filePath
              });
            }));
          case 18:
          ...
          case 25:
            ...
            (0, _logger.logger)().error('Some file already exist, you need to compare folder manually', _context.t0.message);
            return _context.abrupt("return");
          case 30:
            (0, _logger.logger)().error('Some file already exist, you need to compare folder manually', {
              error: _context.t0
            });
          case 31:
          case "end":
