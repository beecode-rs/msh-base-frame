...
var FileAdapter = exports.FileAdapter = /*#__PURE__*/function () {
  ...
  return _createClass(FileAdapter, [{
    key: "copy",
    value: function () {
      var _copy2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
    ...
    value: function () {
      var _copyFilesIfNotExists = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
    ...
    key: "filterFiles",
    value: function () {
      var _filterFiles = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(params) {
        var _this = this;
          ...
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return Promise.all(fileFolderPathList.map(/*#__PURE__*/function () {
                var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(fileFolderPath) {
                  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      ...
                      case 2:
                        ...
                        return _context3.abrupt("return", fileFolderPath);
                      case 4:
            ...
            case 3:
              ...
              return _context4.abrupt("return", filtered.filter(_arrayUtil.arrayUtil.notEmpty));
            case 5:
            case "end":
    ...
    value: function () {
      var _getFolderContent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(params) {
        var folderPath;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              folderPath = params.folderPath;
              return _context5.abrupt("return", _fs.promises.readdir(folderPath));
            case 2:
            case "end":
    ...
    value: function () {
      var _getRecurringFolderContent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params) {
        var _this2 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 7:
              folderContent = _context6.sent.map(function (folderContentPath) {
    ...
    key: "isDirectory",
    value: function () {
      var _isDirectory = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(params) {
        var folderPath, stat;
    ...
    key: "isFile",
    value: function () {
      var _isFile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(params) {
        var filePath, stat;
    ...
    value: function () {
      var _makeFolderIfNotExist = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(params) {
        var folderPath;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 5:
              return _context9.abrupt("return", _fs.promises.mkdir(folderPath));
            case 6:
            case "end":
    ...
    key: "readFile",
    value: function () {
      var _readFile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(params) {
        var filePath;
    ...
    key: "removeFile",
    value: function () {
      var _removeFile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11(params) {
        var filePath;
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 5:
              return _context11.abrupt("return", _fs.promises.rm(filePath));
            case 6:
            case "end":
    ...
    key: "removeFolder",
    value: function () {
      var _removeFolder = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12(params) {
        var folderPath;
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            ...
            case 5:
              return _context12.abrupt("return", _fs.promises.rm(folderPath, {
                force: true,
                recursive: true
              }));
            case 6:
